								...
								<table width="452" height="290" border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td align="center" valign="bottom" background="<c:url value='/images/loginbg.gif'/>">
											<s:form action="accountLoginM.action" namespace="/" theme="simple">
												<table border="0" align="center" cellpadding="2" cellspacing="0">
													<tr align="center">
														<td height="30" colspan="2" style="border-bottom: 1px dotted #cccccc">
															<strong style="font-size: 14px;">请登录</strong>
															<p style="color:red;font-weight:900;"><s:actionerror style="color:red"/> <p>
														</td>
													</tr>
													<tr>
														<td height="30" nowrap>
														...
														<td>
															<s:textfield name="username" value="" id="loginname" class="text" style="width: 160px;"/>
														</td>
													</tr>
													<tr>
														<td height="30" nowrap>
														...
														<td>
															<s:password name="password" id="loginpass" class="text" style="width: 160px;"/>
														</td>
													</tr>
													<tr>
